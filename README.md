...
<head>
  ...
  <style>
    ...
    /* Pantalla 2: Gatito, frases, corazones y canción */
    #screen2 {
      background: #ffe6e6;
      text-align: center;
      padding-top: 30px;
  ...
  <div id="screen4" class="screen">
    ...
    <div class="slider">
      <div class="slides">
        ...
        <div class="slide">
          <iframe src="https://player.vimeo.com/video/12345678" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="width:100%;"></iframe>
